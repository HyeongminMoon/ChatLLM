# ChatLLM
A platform for training, inferencing, serving, apis, and evaluating large language models. 
This repository is based on FastChat.
Integrating various area of cutting edge technologies about LLMs.

--------------------------
And this is from FastChat
## Contents
- [Install](#install)
