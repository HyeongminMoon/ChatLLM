...
def get_urls_from_search_engine(query, search_engine="http://127.0.0.1:8080/", max_urls=3):
...
def get_contents_from_search_engine(query, search_engine="http://127.0.0.1:8080/", max_urls=3):
    query_url = f"{search_engine}?q={query}&format=json"
