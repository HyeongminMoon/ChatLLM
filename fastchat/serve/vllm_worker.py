...
from fastchat.serve.inference import stop_event
...
async def api_generate_stream(request: Request):
    ...
    if "session_id" in params:
        ...
        logger.info(f"session_id: {params['session_id']}")
    else:
        request_id = random_uuid()
        logger.info(f"session_id is randomly generated")
    params["request_id"] = request_id
    worker.set_request_id(request_id)
