...
deepspeed --master_port=11000 --include localhost:0,1,2,3 fastchat/train/train_lora_custom.py \
    --model_name_or_path /workspaces/disk0/data/llm_weights/SOLARC-M-10.7B \
    --lora_r 8 \
    --lora_alpha 32 \
    --lora_dropout 0.05 \
